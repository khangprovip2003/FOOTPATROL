...
<html lang="en">
    ...
    <body>
        ...
        <section class="vh-100" style="background: linear-gradient(90deg, #C7C5F4, #776BCC);">
                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                        <img src="https://img.freepik.com/free-photo/computer-security-with-login-password-padlock_107791-16191.jpg?w=1060&t=st=1697654502~exp=1697655102~hmac=9b4b9c050bd16d70afdd3b46cbde9695dc37eac15f5d8569c1b78038b99b67f2"
