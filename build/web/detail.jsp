...
<html lang="en">
    ...
    <body>
        ...
        <!-- Product section-->
        <section class="py-5">
            <div class="container1 px-4 px-lg-5 my-5">
                            ...
                            <div class="card h-100">
                                ...
                                <a href="detail?productId=${L.id}">
                                    ...
                                    <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                        <div class="text-center"><a class="btn btn-outline-dark mt-auto listLast" href="add-to-cart?productId=${L.id}">Add to cart</a></div>
                                    </div>
                            </div>
                        </div>
                    </c:forEach>
