...
<nav class="navbar navbar-expand-lg navbar-light bg-light" style="background: linear-gradient(90deg, #FAE9D9, #B8A89D);">
    <div class="container px-4 px-lg-5">
        <a class="navbar-brand" href="home">Fashion Foots</a>
        <!-- Điều hướng trên mobile  với Bootstrap -->
        <button 
        ...
        <!--  collapse navbar-collapse giúp điều khiển việc mở rộng/thu gọn nội dung bên trong thanh điều hướng để tạo hiệu ứng responsive(mobile) -->
