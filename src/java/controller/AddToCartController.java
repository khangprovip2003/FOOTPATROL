...
public class AddToCartController extends BaseRequiredAuthenController {
    ...
    protected void processRequests(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            int productId = Integer.parseInt(request.getParameter("productId"));// Lấy id sản phẩm thêm vào giỏ hàng
            //map    productId | cart
            ...
            if (carts.containsKey(productId)) {//sản phẩm đã có trên giỏ hàng
                ...
                carts.put(productId, new Cart(product, 1));//thêm một sản phẩm mới vào trong giỏ hàng
            }
...
//Map lấy lại session là lấy data cũ mà đã add lên     
