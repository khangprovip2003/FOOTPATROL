...
public class EditProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        //Gán các giá trị này vào các trường của đối tượng Product.
        ...
        Account a = (Account) session.getAttribute("acc");//Sử dụng session để lấy ra đối tượng Account đăng nhập hiện tại.
        int cid = a.getUid();//Gán id của người bán vào trường sell_ID của sản phẩm
        product.setSell_ID(cid);
        ProductDBContext pdb = new ProductDBContext();
        pdb.updateProduct(product);//update sản phẩm
